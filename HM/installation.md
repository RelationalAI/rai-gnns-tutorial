...
GRANT USAGE ON DATABASE HM_DB TO APPLICATION RAI_EXPT_APP;
GRANT USAGE ON ALL SCHEMAS IN DATABASE HM_DB TO APPLICATION RAI_EXPT_APP;
GRANT SELECT, INSERT, UPDATE, DELETE ON ALL TABLES IN DATABASE HM_DB TO APPLICATION RAI_EXPT_APP;
